...
class ApartamentosControllerTest < ActionController::TestCase
  ...
  test "should create apartamento" do
    assert_difference('Apartamento.count') do
      post :create, apartamento: { nro_habitantes: @apartamento.nro_habitantes, numero: @apartamento.numero, piso: @apartamento.piso, torre: @apartamento.torre }
    end
  ...
  test "should update apartamento" do
    patch :update, id: @apartamento, apartamento: { nro_habitantes: @apartamento.nro_habitantes, numero: @apartamento.numero, piso: @apartamento.piso, torre: @apartamento.torre }
    assert_redirected_to apartamento_path(assigns(:apartamento))
  end
